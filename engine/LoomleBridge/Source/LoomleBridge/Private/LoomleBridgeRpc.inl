...
TSharedPtr<FJsonObject> FLoomleBridgeModule::BuildRpcCapabilitiesResult() const
{
    ...
    Result->SetArrayField(TEXT("tools"), MakeStringArray({
        ...
        TEXT("widget.palette"), TEXT("widget.tree.inspect"), TEXT("widget.tree.edit"), TEXT("widget.edit"), TEXT("widget.event.create"), TEXT("widget.inspect"), TEXT("widget.compile")
    }));
...
TSharedPtr<FJsonObject> FLoomleBridgeModule::DispatchTool(const FString& Name, const TSharedPtr<FJsonObject>& Arguments, bool& bOutIsError)
{
    ...
    {
        Payload = BuildBlueprintPaletteToolResult(Arguments);
    }
    else if (Name.Equals(TEXT("sal.query")))
    {
        Payload = Loomle::Sal::FSalModule::BuildQueryResult(Arguments);
    }
    else if (Name.Equals(TEXT("sal.patch")))
    {
        Payload = Loomle::Sal::FSalModule::BuildPatchResult(Arguments);
    }
    ...
    else if (Name.Equals(TEXT("widget.edit")))
    {
        Payload = BuildWidgetEditToolResult(Arguments);
    }
    else if (Name.Equals(TEXT("widget.event.create")))
    {
        Payload = BuildWidgetEventCreateToolResult(Arguments);
    }
