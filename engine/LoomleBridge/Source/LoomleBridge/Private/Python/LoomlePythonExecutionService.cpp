...
FString BuildRunnerSource(const FString& SourcePath, const FString& ResultPath)
{
    return FString::Printf(
        TEXT(
            ...
            "            path = get_path()\n"
            "        except TypeError:\n"
            "            raise _LoomleResultError('sal.object() requires a Unreal Engine object instance, not a class')\n"
            "        marker = {_LOOMLE_SAL_OBJECT_KEY: path}\n"
            "        _LOOMLE_SAL_MARKERS.add(id(marker))\n"
            "        return marker\n"
            ...
            "        if _LOOMLE_SAL_OBJECT_KEY in value and id(value) not in _LOOMLE_SAL_MARKERS:\n"
