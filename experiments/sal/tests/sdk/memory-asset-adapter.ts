...
const sal = createSal({ adapters: [createMemoryAssetAdapter({ assets })] });

const doorQuery = await sal.query(`query asset
find assets "door"
...
const firstPage = await sal.query(`query asset
find assets
order by path asc
page limit 1
`);
...
const secondPage = await sal.query(`query asset
find assets
order by path asc
page limit 1
...
const withoutTags = await sal.query(`query asset
find assets "menu"
`);
...
const unsupportedDetail = await sal.query(`query asset
find assets
with pins
`);
...
const unsupportedWhere = await sal.query(`query asset
find assets
...
const unsupportedOrder = await sal.query(`query asset
find assets
