...
Write-Host "[loomle-bootstrap] LOOMLE installs both plugin binaries and plugin source by default."
Write-Host "[loomle-bootstrap] to check for future updates inside an installed project, run:"
Write-Host "  loomle update"
Write-Host "[loomle-bootstrap] to upgrade an installed project in place, run:"
Write-Host "  loomle update --apply"
