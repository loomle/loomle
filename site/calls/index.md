...
nav_order: 5
has_children: true
description: The five public Loomle MCP tools and the boundary each one owns.
permalink: /calls/
---

# MCP Calls

The Loomle Client exposes five public MCP tools. Project selection and editor
...
The five MCP calls describe transport and session boundaries. The six active
...
Start with [Project Binding](project.html), then read
