...
All five conditions were first satisfied by protocol v3. Protocol v4 added
Editor transport operations and protocol v5 adds Python fallback execution,
neither changing this SAL model. Current normative
